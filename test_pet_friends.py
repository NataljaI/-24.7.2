...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Мишка", "медведь", "15", "images/bear.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Джерси', animal_type='кошка', age=18):
...
def test_successful_create_pet_simple(name=name2, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии"""
...
def test_create_pet_simple_with_49_simbols_name(name=name49, animal_type=animal_type2, age=age2):
    """Проверяем возвожность создания питомца без фотографии c именем в 49 символов"""
...
def test_create_pet_simple_with_50_simbols_name(name=name50, animal_type=animal_type2, age=age2):
    """Проверяем возвожность создания питомца без фотографии c именем в 50 символов"""
...
def test_create_pet_simple_with_51_simbols_name(name=name51, animal_type=animal_type2, age=age2):
    """Проверяем возвожность создания питомца без фотографии c именем в 51 символ"""
...
def test_create_pet_simple_with_99_simbols_name(name=name99, animal_type=animal_type2, age=age2):
    """Проверяем возвожность создания питомца без фотографии c именем в 99 символов"""
...
def test_create_pet_simple_with_empty_name(name=name_empty, animal_type=animal_type2, age=age2):
    """Проверяем возвожность создания питомца без фотографии c пустым именем. Тут есть момент, что бэк пропускает
    пустое значение, но фронт выдает информер о необходимости ввести имя питомца"""
